...
def CreateTensor3(nrows = None, ncols = None, nz = None, rowclust = None, colclust = None, zclust = None, noise = 0, v_rowclust = None, v_colclust = None, v_zclust = None, max_attempts = 1):
...
def CreateTensor(n= None, nclust = None, noise = 0, max_attempts = 1, last_iteration = True):
    """
